...
func (r *Repl) printBanner(serverEnabled bool) {
	...
	fmt.Println("/skill list           list skills visible in this group")
	fmt.Println("/skill reload         rescan the skill directory")
	fmt.Println("/skill warnings       show skill load warnings")
