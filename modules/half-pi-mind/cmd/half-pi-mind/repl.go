...
func runREPL(conversations *conversation.Manager, bus *events.EventBus, db *store.Store, serverEnabled bool, wsHub *hub.Hub) {
	...
	repl.Run(actor, switchActor, bus, db, conversations.GroupID(), serverEnabled, wsHub)
}
